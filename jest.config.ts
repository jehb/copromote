...
const config: Config = {
    ...
    collectCoverageFrom: [
        ...
        '!components/gallery/album-editor.tsx',
        '!components/gallery/meta-editor.tsx',
        '!components/gallery/selection-modal.tsx',
        '!components/gallery/upload-modal.tsx',
        '!components/gallery/gallery-client.tsx',
        '!components/layout/connection-status.tsx',
        '!components/builder/**',
        '!components/calendar/**',
        '!components/chat/**',
        '!components/email-planner/**',
        '!components/contacts/contact-client-page.tsx',
        '!components/admin/**',
        '!components/asset-editor/**',
        '!app/**',
    ],
}
