...
export default async function EmailPlanDetailPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    // Execute independent data queries concurrently via Promise.all
    // to avoid sequential waterfall latency and speed up page rendering.
            ...
            <div className="max-w-4xl mx-auto space-y-8">
                ...
                <section>
                    ...
                    <div className="space-y-4">
                        <EmailItemList items={planItems} availableEvents={events} availableProducts={availableProducts} availableAssets={savedAssets} availablePhotos={photos} />
                    </div>
                </section>
            </div>
        </div>
