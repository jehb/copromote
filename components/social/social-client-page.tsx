...
export function SocialClientPage({ initialData, initialFilters }: SocialClientPageProps) {
    ...
    return (
        <div className="p-4 md:p-8 space-y-4 md:space-y-8 h-full flex flex-col w-full overflow-hidden">
            <PageHeader
                title={
            ...
            <div className="flex gap-2 pb-4 border-b border-slate-100 overflow-x-auto scrollbar-hide shrink-0">
