...
async function main() {
  ...
  const defaultLocationName = "Weaver Street Market";
  ...
  while (true) {
    const url = `https://www.weaverstreetmarket.coop/wp-json/tribe/events/v1/events?start_date=2026-01-01&end_date=2026-12-31&page=${page}&per_page=50`;
